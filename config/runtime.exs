...
#
#     PHX_SERVER=true bin/embedding_generator start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :embedding_generator, EmbeddingGeneratorWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :embedding_generator, EmbeddingGenerator.Repo,
    ssl: true,
    ssl_opts: [
      cacertfile: System.get_env("DO_DB_SSL_CERT")
    ],
    hostname: System.get_env("DO_DB_HOSTNAME"),
    port: System.get_env("DO_DB_PORT"),
    username: System.get_env("DO_DB_USERNAME"),
    password: System.get_env("DO_DB_PASSWORD"),
    database: System.get_env("DO_DB_NAME"),
    pool_size: 10
  ...
  config :ex_aws, :s3,
    scheme: "https://",
    host: "#{System.get_env("BUCKET_NAME")}.sfo2.digitaloceanspaces.com",
    region: "sfo2"
  ...
  config :embedding_generator, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :embedding_generator, EmbeddingGenerator.Mailer,
